...
<div class="form-container">
    ...
    <form action="{{route('form.store')}}" method="POST" class='Form'>
        ...
        <div class="form-group">
            ...
            <select id="t_type" name="t_type" value= "{{$data->t_type}}" disabled>
        ...
        <div class="form-group">
            ...
            <select id="nationality" name="nationality" value= "{{$data->nationality}}" disabled>
        ...
        <div class="form-group">
            ...
            <input type="date" id="date" name="date" value= "{{$data->date}}" disabled>
        </div>
        <div class="form-group">
            <label for="time">Event Time:</label>
            <input type="time" id="time" name="time" value= "{{$data->time}}" disabled>
        </div>
        <div class="form-group">
            <label for="quantity">Quantity:</label>
            <input type="number" id="quantity" name="quantity" min="1" max="10" value= "{{$data->quantity}}" disabled>
        </div>
